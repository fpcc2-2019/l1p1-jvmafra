...
ggplot(data = junho.agrupado.por.ano, aes(x = ano, y = temp_media)) + geom_bar(stat = "identity", position = "dodge", fill = "#FF6666") + ylab("Média das temperaturas médias semanais") + xlab("Ano") + 
...
ggplot(data = junho.agrupado.por.ano, aes(x = ano, y = temp_media)) + geom_bar(stat = "identity", position = "dodge", fill = "#FF6666") + ylab("Média das temperaturas mínimas semanais") + xlab("Ano") + 
    scale_x_discrete(limits = c(1995:2018)) + coord_flip()
```
