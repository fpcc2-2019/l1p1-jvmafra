...
ggplot(data = junho.agrupado.por.ano, aes(x = reorder(ano, temp_media), y = temp_media)) + geom_bar(stat = "identity", position = "dodge", fill = "#FF6666") + ylab("Média das temperaturas mínimas semanais") + xlab("Ano") + coord_flip()
```
